...
public:
	...
	Event_Data_Network_Player_Game_Node_Assignment()
	{
		m_GameNodeId = INVALID_GAME_NODE_ID;
	...
	virtual IEventDataPtr VCopy()
	{
		return IEventDataPtr(new Event_Data_New_Game_Node(m_GameNodeId, m_ConnectionId));
	}
...
class Event_Data_Server_Stop : public BaseEventData
{
public:
	static const EventType g_EventType;

	Event_Data_Server_Stop()
	{
	}
	...
	virtual IEventDataPtr VCopy()
	{
		return IEventDataPtr(new Event_Data_Server_Stop());
	}
